                    ...
                    <div className="p-1">
                      <Card className="rounded-lg shadow-md  border-none py-8">
                        <CardHeader>
                          ...
                          <CardTitle className="font-bold text-desc text-2xl mt-4">{carrousel.title}</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <CardDescription className="text-md">{carrousel.description}</CardDescription>
                        </CardContent>
                      </Card>
                    </div>
                  </CarouselItem>
