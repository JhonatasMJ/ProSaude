        ...
        <div className="ml-auto max-w-[620px]">
          ...
          >
            ...
            <p className="text-desc mt-8  ">
              Atuamos com excelência no atendimento, respeito à vida e
              compromisso com a melhoria contínua, garantindo qualidade e
              confiança para empresas e trabalhadores.
            </p>
          </motion.div>
          <motion.div
            className="flex flex-col md:flex-row  gap-4 mt-20"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ amount: 0.3 }}
          ...
          >
            ...
            <Link to="contact" smooth={true} duration={500} className="flex-1">
              <motion.div
